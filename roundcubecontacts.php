<?php
/***********************************************
* File      :   rondcubecontacts.php
* Project   :   Z-Push
* Descr     :   This backend is for roundcube contacts in MySQL
*
* Created   :   20.01.2013
*
* Based on Zarafa's vcard directory backend
* Rouncube modifications by Alex Charrett <alex@transposed.org>
*
* The following applies to the original vcard directory version:
*
